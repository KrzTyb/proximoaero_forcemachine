...
private:
    GPIO m_redLed {16, GPIO_TYPE::OUTPUT, true};
    GPIO m_blueLed {20, GPIO_TYPE::OUTPUT, true};
    GPIO m_greenLed {21, GPIO_TYPE::OUTPUT, true};
    GPIO m_whiteLed {13, GPIO_TYPE::OUTPUT, true};

    GPIO m_bolt {23, GPIO_TYPE::OUTPUT, true};
    GPIO m_supportingElectromagnet {24, GPIO_TYPE::OUTPUT, true};
};
